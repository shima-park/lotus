...
type pipeliner struct {
	...
	name       string
	components []executor.Component
	processors []executor.Processor
...
func (p *pipeliner) init(conf Config) *pipeliner {
	...
	var pm = map[string]executor.Processor{}
...
func (p *pipeliner) ListComponents() []executor.Component {
	return p.components
}

func (p *pipeliner) ListProcessors() []executor.Processor {
	return p.processors
}
...
func (p *pipeliner) Config() string {
